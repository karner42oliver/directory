...
global $wp_query, $wp_taxonomies, $post, $post_ID;
...
<div class="dr_update_form">
	...
	<form class="standard-form base" method="post" action="#" enctype="multipart/form-data" id="dr_update_form" >
		...
		<script type="text/javascript" > jQuery('#tag_<?php echo $tag_name; ?>').tagsInput({width:'auto', height:'150px', defaultText: '<?php _e("füge ein Schlagwort hinzu", $this->text_domain); ?>'}); </script>
		<?php endforeach; ?>
