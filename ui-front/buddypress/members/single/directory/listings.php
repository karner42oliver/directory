                    ...
                    <div class="entry-meta">
                        ...
                        <div class="entry-utility">
                            <?php if ($categories_list): ?>
                                <span class="cat-links"><?php echo sprintf(__('Veröffentlicht in %s', $this->text_domain), $categories_list); ?></span><br />
                                <?php unset($categories_list); ?>
                            <?php endif; ?>
                            <?php if ($tags_list): ?>
                                <span class="tag-links"><?php echo sprintf(__('Markiert %s', $this->text_domain), $tags_list); ?></span><br />
                                <?php unset($tags_list); ?>
                            <?php endif; ?>
