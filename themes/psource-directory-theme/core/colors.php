		...
		*/
		function output_admin_page() {
			...
			<div class="wrap">
				...
				<?php if ( isset( $msg ) ) : ?>
					<div class="updated fade"><p><strong><?php echo $msg; ?></strong></p>
			</div>
				<?php endif; ?>
			...
			<form method="post" action="options.php">
				...
				<label>
					<input type="checkbox" name="dir_colors[enable]" value="1" <?php checked(! empty($colors['enable'] ) ); ?> /> <?php _e('Farbüberschreibungen zulassen.', THEME_TEXT_DOMAIN); ?></label>
