...
class DR_Theme_Core {
	...
	*/
	function register_sidebars() {
		...
		'description' => __( 'Der erste Fußzeilen-Widget-Bereich', THEME_TEXT_DOMAIN ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
		...
		'description' => __( 'Der dritte Fußzeilen-Widget-Bereich', THEME_TEXT_DOMAIN ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	*/
	function ad_banners(){
		if (is_active_sidebar('advertise-widget')) {
			...
			echo '<span>' .  __( 'Deine Werbung hier!', $this->text_domain ) . '</span>';
		}
	}
