	...
	<div class="padder">
		<div class="page" id="blog-archives"><!-- start #blog-archives -->
            ...
            <?php if ( $Directory_Core->is_full_access() ): ?>
                <div class="av-credits"><?php _e( 'Du hast Zugriff, um neue Einträge zu erstellen', $Directory_Core->text_domain ); ?></div>
            <?php elseif($Directory_Core->use_credits): ?>
                <div class="av-credits"><?php _e( 'Verfügbare Credits:', $Directory_Core->text_domain ); ?> <?php echo $Directory_Core->transactions->credits; ?></div>
            <?php endif; ?>
            ...
            <div>
                ...
                <?php echo do_shortcode('[dr_my_credits_btn text="'. __('Meine Credits', $Directory_Core->text_domain) . '" view="loggedin"]'); ?>
            </div>
            ...
            <?php if ( count( $custom_query->posts ) ) : ?>
				...
				<span class="edit">
					<a title="Edit this listing" href="javascript:;" onclick="dr_listings.edit( '<?php echo $listing->ID; ?>' );" ><?php _e( 'Bearbeiten', DR_TEXT_DOMAIN ); ?></a>
				</span>

                                    <?php if(current_user_can( 'delete_listings' )): ?>
                                        <span class="delete" id="delete-<?php echo $listing->ID; ?>"> |
					<a title="Delete this listing" href="javascript:;" onclick="dr_listings.toggle_delete( '<?php echo $listing->ID; ?>' );" ><?php _e( 'Löschen', DR_TEXT_DOMAIN ); ?></a>
				</span>
                                    <?php endif; ?>
