...
<div class="post" id="post-<?php the_ID(); ?>">
	...
	<div class="entry">
		...
		<?php the_content( __('<p class="serif">Zum Rest dieses Eintrags &rarr;</p>', THEME_TEXT_DOMAIN ) ); ?>
		<?php wp_link_pages( array( 'before' => __( '<p><strong>Seiten:</strong> ', THEME_TEXT_DOMAIN ), 'after' => '</p>', 'next_or_number' => 'number')); ?>
	</div>
</div>
