	...
	private function _set_up_sidebar () {
		...
		if ( defined( 'PSOURCE_REMOVE_BRANDING' ) && constant( 'PSOURCE_REMOVE_BRANDING' ) ) {
			$this->_dr_sidebar .= '<p>' . __( 'The Directory plugin transforming your WordPress install from a blogging platform into a powerful online directory with loads of features and built in payment gateways.', $this->text_domain ) . '</p>';
				...
				$this->_dr_sidebar .= '<ul>' .
					'<li><a href="https://github.com/cp-psource/directory" target="_blank">' . __( 'Project page', $this->text_domain ) . '</a></li>' .
					'<li><a href="https://github.com/cp-psource/directory" target="_blank">' . __( 'Installation and instructions page', $this->text_domain ) . '</a></li>' .
					'<li><a href="https://github.com/cp-psource/directory" target="_blank">' . __( 'Support forum', $this->text_domain ) . '</a></li>' .
				'</ul>' .
			'';
		}
	}
